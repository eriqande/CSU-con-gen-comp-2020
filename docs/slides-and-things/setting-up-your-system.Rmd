...
* From your GitHub home page, click the green "New" button.
* In the repository name box, type `a-first-project`
* Include a short description if you want to.
* Leave it a Public repository.
* **Do Not** Initialize with a README.
* **Do Not** Add .gitignore or a license
* Hit Create Repository

At this point you get two command lines under **"…or push an existing repository from the command line"**.

In your RStudio "a-first-project" project, choose Tools->Terminal->New Terminal, and paste those two command lines into there and hit return.  That should push your project up to GitHub.
